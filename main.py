...
os.environ['TF_CPP_MIN_VLOG_LEVEL'] = '3'  # 日志等级1显示所有信息，2只显示warning和error，3只显示Error
...
if __name__ == '__main__':
    # 定义参数
    trainingFile = "data/nlpcc-iccpol-2016.dbqa.training-data"
    developFile = "data/nlpcc-iccpol-2016.dbqa.validation-data"
    testingFile = "data/nlpcc-iccpol-2016.dbqa.testing-data"
    resultFile = "predictRst.score"
    saveFile = "newModel/savedModel"
    trainedModel = "trainedModel/savedModel"
    embeddingFile = "word2vec/wiki_chs_50.txt"
